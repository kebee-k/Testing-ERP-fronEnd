...
public class addEmployee extends basesClass {
    ...
    @Test(dependsOnMethods = {"addEmployeeToFinanceDept"})
    ...
    public void addEmployeeToLogisticDept() throws InterruptedException {
        ...
        for (int rowNUm = 1; rowNUm <= rowCount; rowNUm++) {
            ...
            Select ell = new Select(driver
                    .findElement(By.xpath("//div[@class='row']//div[@class='col-md-4']//select[@class='form-control']")));
            ell.selectByVisibleText("Logistics");
            Thread.sleep(10);
            Select ell2 = new Select(
                    driver.findElement(By.xpath("//div[@class='row']//div[@class='col-md-4']//select[@id='test']")));
            ell2.selectByVisibleText("Logistics Coordinator");
            Thread.sleep(10);
            Select ell22 = new Select(
                    driver.findElement(By.xpath("//div[@class='row']//div[@class='col-md-4']//select[@id='test1']")));
            ell22.selectByVisibleText("Senior");
    ...
    public void addEmployeeProcurementDept() throws InterruptedException {
        ...
        Select ell = new Select(driver
                .findElement(By.xpath("//div[@class='row']//div[@class='col-md-4']//select[@class='form-control']")));
        ell.selectByVisibleText("Procurement");
        Thread.sleep(10);
        Select ell2 = new Select(
                driver.findElement(By.xpath("//div[@class='row']//div[@class='col-md-4']//select[@id='test']")));
        ell2.selectByVisibleText("Purchase Manager");
        Thread.sleep(10);
        Select ell22 = new Select(
                driver.findElement(By.xpath("//div[@class='row']//div[@class='col-md-4']//select[@id='test1']")));
        ell22.selectByVisibleText("Senior");
    ...
    public void  addEmployeeToManufactureDept() throws InterruptedException {
        ...
        for (int rowNUm = 1; rowNUm <= rowCount; rowNUm++) {
            ...
            Select ell = new Select(driver
                    .findElement(By.xpath("//div[@class='row']//div[@class='col-md-4']//select[@class='form-control']")));
            ell.selectByVisibleText("Manufacturing");
            Thread.sleep(10);
            Select ell2 = new Select(
                    driver.findElement(By.xpath("//div[@class='row']//div[@class='col-md-4']//select[@id='test']")));
            ell2.selectByVisibleText("Production Planning Manager");
            Thread.sleep(10);
            Select ell22 = new Select(
                    driver.findElement(By.xpath("//div[@class='row']//div[@class='col-md-4']//select[@id='test1']")));
            ell22.selectByVisibleText("Senior");
